...
Завантажити документ
    ...
    ...    ${ARGUMENTS[2]} == ${TENDER}
    sets.Пошук тендера по ідентифікатору    ${ARGUMENTS[0]}    ${ARGUMENTS[2]}
    Click Element    id=lot-update-btn
...
Отримати інформацію із предмету
    ...
    ${return_value}=    Run Keyword And Return    sets.Отримати інформацію із тендера    ${username}    ${tender_uaid}    ${field_name}
    [Return]    ${return_value}
